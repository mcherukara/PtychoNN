...
# Basic paths
base_path = "/grand/hp-ptycho/anakha/S26-beamtime" ## change here 
out_path = f"{base_path}/18June2022" ## change here 
search_path = f"{base_path}/Training2" ## this is the train folder 
...
if __name__ == '__main__':
    ...
    post_message(f"PtychoNN: Completed training run for diffraction data downscaled by a factor of {diffraction_downscaling}.")
